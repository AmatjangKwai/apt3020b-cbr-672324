...
they are experiencing it captures the information the steudent provides then to 
to retrive the stored solved problems and compares them to try and find the most
...
as a solution for the current one
Revise-if that solution is not properly fitting the current prooblem the system will offer an opportunity to tailor
